...
cv2.imshow('RGLights',cv2.resize(intro, (0, 0), fx = 0.5, fy = 0.5) )
cv2.waitKey(125) 
...
if not win:
    for i in range(10):
        cv2.imshow('RGLights',cv2.resize(kill, (0, 0), fx = 0.5, fy = 0.5))
    ...
    cv2.imshow('RGLights',cv2.resize(winner, (0, 0), fx = 0.5, fy = 0.5))
    cv2.waitKey(125)    
